...
<title>BASS - Music Event Website Template html5 bootstrap</title>
<link rel="stylesheet" href="{{ asset('FEmusic/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ asset('FEmusic/css/flexslider.css') }}">
<link rel="stylesheet" href="{{ asset('FEmusic/css/jquery.fancybox.css') }}">
<link rel="stylesheet" href="{{ asset('FEmusic/css/main.css') }}"> 
<link href="{{ asset('FEmusic/jPlayer-2.9.2/dist/skin/pink.flag/css/jplayer.pink.flag.min.css') }}" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="{{ asset('FEmusic/css/responsive.css') }}">
<link rel="stylesheet" href="{{ asset('FEmusic/css/font-icon.css') }}">
<link rel="stylesheet" href="{{ asset('FEmusic/css/animate.min.css') }}">
...
<section class="banner" role="banner" id="banner">
  <header id="header">
    <div class="header-content clearfix"> <span class="logo"><a href="index.html">Music Bank</a></span>
...
<!-- header section --> 
<!-- intro section -->
<section id="intro" class="section intro bg-gray">
  <div class="container">
...
<section id="gallery" class="gallery section">
  <div class="container-fluid">
    ...
    <div class="row no-gutter">
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="{{ asset('FEmusic/images/portfolio/01.jpg') }}" class="work-box"> <img src="{{ asset('FEmusic/images/portfolio/01.jpg') }}" alt="">
        <div class="overlay">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="{{ asset('FEmusic/images/portfolio/02.jpg') }}" class="work-box"> <img src="{{ asset('FEmusic/images/portfolio/02.jpg') }}" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="{{ asset('FEmusic/images/portfolio/03.jpg') }}" class="work-box"> <img src="{{ asset('FEmusic/images/portfolio/03.jpg') }}" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="{{ asset('FEmusic/images/portfolio/04.jpg') }}" class="work-box"> <img src="{{ asset('FEmusic/images/portfolio/04.jpg') }}" alt="">
        <div class="overlay">
          <div class="overlay-caption"> 
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="{{ asset('FEmusic/images/portfolio/05.jpg') }}" class="work-box"> <img src="{{ asset('FEmusic/images/portfolio/05.jpg') }}" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="{{ asset('FEmusic/images/portfolio/06.jpg') }}" class="work-box"> <img src="{{ asset('FEmusic/images/portfolio/06.jpg') }}" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="{{ asset('FEmusic/images/portfolio/07.jpg') }}" class="work-box"> <img src="{{ asset('FEmusic/images/portfolio/07.jpg') }}" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="{{ asset('{FEmusic/images/portfolio/08.jpg}') }}" class="work-box"> <img src="{{ asset('FEmusic/images/portfolio/08.jpg') }}" alt="">
        <div class="overlay">
          <div class="overlay-caption">
             <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6">
        <div class="person"><img src="FEmusic/images/team-1.jpg" alt="" class="img-responsive">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="person"> <img src="{{ asset('FEmusic/images/team-2.jpg') }}" alt="" class="img-responsive">
          <div class="person-content">
            <h4>Markus Linn</h4>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="person"> <img src="{{ asset('FEmusic/images/team-3.jpg') }}" alt="" class="img-responsive">
          <div class="person-content">
            <h4>Chris Jemes</h4>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="person"> <img src="{{ asset('FEmusic/images/team-4.jpg') }}" alt="" class="img-responsive">
          <div class="person-content">
            <h4>Vintes Mars</h4>
...
<script src="{{ asset('FEmusic/js/bootstrap.min.js') }}"></script> 
<script src="{{ asset('FEmusic/js/jquery.flexslider-min.js') }}"></script> 
<script src="{{ asset('FEmusic/js/jquery.fancybox.pack.js') }}"></script> 
<script src="{{ asset('FEmusic/js/retina.min.js') }}"></script> 
<script src="{{ asset('FEmusic/js/modernizr.js') }}"></script> 
<script src="{{ asset('FEmusic/js/main.js') }}"></script> 
<script type="text/javascript" src="{{ asset('FEmusic/js/jquery.contact.js') }}"></script> 

<script type="text/javascript" src="{{ asset('FEmusic/jPlayer-2.9.2/dist/jplayer/jquery.jplayer.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('FEmusic/jPlayer-2.9.2/dist/add-on/jplayer.playlist.min.js') }}"></script> 
